...
class HomeController extends Controller
{
    ...
    public function new()
    {
        ...
        return view('vendor.homes.new')->with('homes',$homes);
    }
    ...
    {
        return view('vendor.homes.create');
    }
    ...
    {
        $home = Home::find($id);
        return view('vendor.homes.show')->with('home',$home);
    }
    ...
    {
        return view('vendor.homes.edit')->with("home",Home::find($id));
    }
    ...
    public function update(Request $request, Home $home )
    {
       ...
       return  redirect()->route('vendor.homes.index',['data' => "homes $request->advertiser_name updated successfully"]);
    }
