...
class GeneralController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.generals.index')->with("generals",General::all());
    }
    ...
    public function new()
    {
        ...
        return view('vendor.generals.new')->with('generals',$general);
    }
    ...
    {
        return view('vendor.generals.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.generals.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('vendor.generals.show')->with('general',$general);
    }
    ...
    {
        return view('vendor.generals.edit')->with("general",General::find($id));
    }
    ...
    public function update(Request $request, General $general )
    {
       ...
       return  redirect()->route('vendor.generals.index',['data' => "general $request->advertiser_name updated successfully"]);
    }
