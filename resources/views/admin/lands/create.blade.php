                                    ...
                                    <tbody class="text-left">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <input type="radio" value="غير ذلك" id="switch23"
                                                    name="located_on" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <input type="radio" value="غير ذلك" id="switch28"
                                                    name="surrounded_by" />
                                                <label for="switch23">غير ذلك</label>
                                                @error('surrounded_by')
                                                    <span class="invalid-feedback" style="display: block;" role="alert">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <input type="checkbox" value="تصلها مياه" id="switch220"
                                                    name="features[]" />
                                                <label for="switch220">تصلها مياه</label>
