            ...
            <div class="row">
                <div class="card w-100">
                    <div class="body-card m-1">
                        ...
                        <form method="post" action="{{ route('admin.mobiles.update', ['mobile' => $mobile->id]) }}"
                            ...
                            <div class="row m-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="reset_model" value="{{ $mobile->reset_model }}" type="text"
                                                class="form-control">
                                            @error('reset_model')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="screen_size" value="{{ $mobile->screen_size }}" type="text"
                                                class="form-control" placeholder="مثال 5 بوصة">
                                            @error('screen_size')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="cameras" value="{{ $mobile->cameras }}" type="text"
                                                class="form-control" placeholder="مثال 18 ميجا خلفية">
                                            @error('cameras')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="memory" value="{{ $mobile->memory }}" type="text"
                                                class="form-control" placeholder="مثال 8">
                                            @error('memory')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="storage" value="{{ $mobile->storage }}" type="text"
                                                class="form-control" placeholder="مثال 16">
                                            @error('storage')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="price" value="{{ $mobile->price }}" type="text"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea rows="8" name="description" type="text" class="form-control"
                                                placeholder="المزيد من المواصفات كل معلومة بسطر">{{ $mobile->description }}</textarea>
                                            @error('description')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="advertiser_name" value="{{ $mobile->advertiser_name }}"
                                                type="text" class="form-control" placeholder="الاسم الحقيقي">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="phone_number" value="{{ $mobile->phone_number }}"
                                                type="text" class="form-control" placeholder="رقم الهاتف مع المقدمة">
                                            @error('phone_number')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="email" value="{{ $mobile->email }}" type="text"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">العنوان</label>
                                        <div class="col-sm-8">
                                            <input name="address" value="{{ $mobile->address }}" type="text"
                                                class="form-control" placeholder="اسم الشارع او المنطقة">
                                            @error('address')
                                                <span class="invalid-feedback" style="display: block;" role="alert">
                                                    {{ $message }}
                                                </span>
