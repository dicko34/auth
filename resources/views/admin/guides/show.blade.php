    ...
    <div class="row mt-4 mb-5">
        <div class="col-lg-12 col-12">
                            ...
                            <div class="row">
                                <div class=" col-12">
                                    <div class="mt-5 m-1">
                                        ...
                                        <div class="row m-2">
                                        @foreach(explode(',',$guide->img) as $img)
                                            <div class="col-4">
                                                <a href="{{ asset('assets/site/images/guides/'.$img) }}"
                                                    class="gallery-popup" style="height: 100px; width:100%">
                                                    <div class="project-item">
                                                        <div class="overlay-container">
                                                            <img src="{{ asset('assets/site/images/guides/'.$img) }}"
            ...
            <div class="row m-0 ">
                <table class="table table-striped  table-bordered mb-0 text-center h5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="">التخصص</td>
                            <td class=""> {{$guide->specialization}} </td>
                        </tr>
                        <tr>
                            <td class="">الدوام</td>
                            <td class="">  {{$guide->permanence}}</td>
                        </tr>
                        <tr>
                            <td class="">عمل ليلي</td>
                            <td class="">{{$guide->night_work}}</td>
                        </tr>
                ...
                <table class="table table-striped  table-bordered mb-0 text-center h5">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class=""> {{$guide->advertiser_name}}</td>
                        </tr>
                        <tr>
                            <td class="">العنوان</td>
                            <td class="">{{$guide->address}}</td>
                        </tr>
                        <tr>
                            <td class="">رقم الهاتف</td>
                            <td class="">{{$guide->phone_number}}</td>
                        </tr>
                        <tr>
                            <td class="">موبايل</td>
                            <td class="">{{$guide->mobile}}</td>
                        </tr>
                        <tr>
            ...
            <div class="row mt-3">
                ...
                <form method="post" action="{{route('admin.guides.change.state',['action'=>$guide->state == 'refused' ? 'allowed' : 'refused','guide'=>$guide->id])}}">
                    @csrf
                    @if($guide->state == 'pinned')
                                                                ...
                                                                @else 
                                                                <button type="submit" value="{{$guide->state == 'blocked'? 'allowed':'blocked' }}" class="btn btn-primary w-md waves-effect waves-light" >{{$guide->state == 'blocked' ? 'قبول' : 'رفض'}}</button>
