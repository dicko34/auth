...
<!-- App favicon -->
    ...
    <!-- Bootstrap Css -->
    <link href="{{asset("admin/libs/magnific-popup/magnific-popup.css")}}" id="bootstrap-style" rel="stylesheet" type="text/css"/>
    <link href="{{asset("admin/css/bootstrap.min.css")}}" id="bootstrap-style" rel="stylesheet" type="text/css"/>
    <!-- Icons Css -->
    <link href="{{asset("admin/css/icons.min.css")}}" rel="stylesheet" type="text/css"/>
    <!-- App Css-->
    @yield("style")
    <link href="{{asset("admin/css/app-rtl.css")}}" rel="stylesheet" type="text/css"/>
            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    ...
                    <a href="index.html" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="{{ asset("admin/images/martina.jpeg") }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset("admin/images/martina.jpeg") }}" alt="" height="22">
                        </span>
                ...
                <div class="row m-100 text-center" >
                    ...
                    <div class="col-6 col-md-4 col-lg-4">
                        ...
                        <div class="Download-Icons">
                            <a href="https://vm.tiktok.com/ZMR5jhvbA/" class="h3 text-primary mr-1"><img src="https://autobazar.souqeljuma.com/site/images/tiktok.png" height="28" width="28" alt=""></a>
                            ...
                            <a href="https://instagram.com/ownk11?utm_medium=copy_link" class="h1"><img src="https://autobazar.souqeljuma.com/site/images/instagram.png" height="28" width="28" alt=""></a>
                        </div>
                    </div>
                    {{--
