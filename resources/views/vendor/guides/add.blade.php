...
@section('content') 
    ...
    <form method="POST" action="{{ route('vendor.guides.store') }}" enctype="multipart/form-data">
        @if ($errors->any())
        ...
        <div class="add-section w-75 mx-auto bg-white">
            <div class="add-section-title btn w-100 bg-primary p-1 px-3 mb-3">
                <h4 class="text-white ml-2 font-weight-bold text-left">إعلان دليل جديد</h4>
            </div>
        ...
        <div class="add-section w-75 mx-auto bg-white">
            @if (!auth()->user())
            <div class="add-section-title btn w-100 bg-primary p-1 px-3 mb-3">
                <h5 class="text-white ml-2 font-weight-bold text-left">معلومات المعلن </h5>
            </div>
            <table class="table table-bordered table-striped mb-0 bg-white">
                <tbody>
                    <tr>
                        <td>
                            اسم المعلن <span class="text-danger" style="font-weight: 700;">*</span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            صفحة الفيسبوك <span class="text-danger" style="font-weight: 700;"></span>
                        </td>
                        <td>
                            <div class="form-group">
