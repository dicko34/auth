    ...
    <div class="w-100 mx-auto bg-white" style="max-width:980px;">
                    ...
                    <div class="float-left text-dark border-right px-2 py-1" style="font-size: 14px;">
                        ...
                        <ul class="d-inline-flex mb-0">
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://www.facebook.com/sharer/sharer.php?u=https://www.wenak.ps/car/{{ $guide->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-facebook-square" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://twitter.com/intent/tweet?text=https://www.wenak.ps/guide/{{ $guide->id }}.html&amp;src=sdkpreparse','newwindow','width=300,height=250'); return false;"
                                    style="color: #888"><i class="fab fa-twitter" style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://api.whatsapp.com/send?text=https://www.wenak.ps/guide/{{ $guide->id }}.html','newwindow','width=1200,height=450'); return false;"
                                    style="color: #888"><i class="fab fa-whatsapp" aria-hidden="true"
                                        style="font-size: 18px;"></i></a>
                            </li>
                            <li class="f-right px-2 py-1" style="font-size: 14px;">
                                <a onclick="window.open('https://mail.google.com/mail/?view=cm&amp;fs=1&amp;tf=1&amp;to=&amp;su=وينك من زمان - سيات | SEAT ابيزا 2009&amp;body=سيات | SEAT ابيزا 2009 https://www.wenak.ps/guide/{{ $guide->id }}.html&amp;ui=2&amp;tf=1&amp;pli=','newwindow','width=1200,height=450'); return false;"
                            ...
                            <div class="media h-100" style="width: 100%;">
                                <div style="position: relative" class="h-100">
                                    <img class="first-img img-fluid"
                                        src="{{ asset('assets/site/images/guides/' . explode(',', $guide->img)[0]) }}"
                                        alt="{{ $guide->specialization }} | {{ $guide->workplace }}"
                                        title="{{ $guide->specialization }} | {{ $guide->workplace }}"
                                ...
                                <div class="media-body px-3 pt-1" style="">
                                    <span style="color: #ff9800;  font-size: 13px ;font-weight: 700">
                                        ...
                                        {{ $guide->city }} {{ $guide->address }}
                                    </span>
                                    <h5 class="mt-2 title " style="    font-size: 1.1rem;font-family:Tajawal">
                                        {{ $guide->specialization }} | {{ $guide->workplace }}</h5>
                                    <li class="old-price not-cut d-block d-lg-none">{{ $guide->price }}</li>
                                </div>
                            </div>
                        </div>
        ...
        <div class="w-100">
                ...
                <div class="row details" style="padding: 0;margin-right: 0px;margin-left: 0px;">
                        ...
                        <div style="    padding: 20px;
                            ...
                            <div class="row " style="min-height: 83px;margin-right: 0px;margin-left: 0px;">
                                <div class="col text-center">
                                    ...
                                    <table class="table table-sm">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>رقم الموبايل</td>
                                                <td><a class="text-dark" href="tel:{{ $guide->mobile }}"> {{ $guide->mobile }}
                                                    </a></td>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="card-footer w-100 mt-3 d-block d-lg-none">
                                    <a href="javascript:ReportModal({{ $guide->id }});">هل وجدت خطأ في الاعلان ؟</a>
                                    <p>رقم الاعلان : {{ $guide->id }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 text-center mt-3">
                                <table class="table table-striped table-sm">
                                    <tbody style="font-weight:500">
                                        ...
                                        <tr>
                                            <td><a dir="ltr" href="tel:{{ $guide->mobile }}" style="font-size: 20px;"> {{ $guide->mobile }} </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-sm-12 col-lg-8 col-xl-9 " style="padding: 13px;">
                        ...
                        <div class="d-none d-lg-block">
                            <div class="row mb-20px">
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> التخصص :</span> {{ $guide->specialization }}
                                </div>
    
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> مكان العمل :</span> {{ $guide->workplace }}
                                </div>
    
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span>الدوام:</span> {{ $guide->permanence }}
                                </div>
                                ...
                                <div class="col-xl-12 col-md-12" style="line-height: 28px;">
                                    <span> معلومات اخرى :</span> <pre>{{ $guide->description }}</pre> 
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-xl-3 border-right border-md-top d-none d-lg-block d-xl-block" style="min-height: 230px;background-color: #fff;">
                        ...
                        <div class="col-md-12 text-center mt-1">
                            <b style="color: #ff9800 ;font-size: 20px;" class="text-dark">{{$guide->advertiser_name}}</b>
                        </div>
                        <div class="col-md-12 text-center mt-3">
                            <table class="table table-sm">
                                <tbody>
            ...
            <div class="w-100 px-1">
                ...
                <div class="row">
                    @foreach ($similar as $guide_similar)
  
                        <div class="col-6 col-xl-2 p-1 ">
                            
                             <div
                                class="annonce-item"style="border: 1px solid;border-color: #0000002b;border-radius: 5px;">
                                <a href="{{ asset('assets/site/images/guides/' . explode(',', $guide_similar['img'])[0]) }}"
                                    class="gallery-popup" style="height: 160px; width:100%">
                                    <div class="project-item">
                                        <div class="overlay-container">
                                            <img src="{{ asset('assets/site/images/guides/' . explode(',', $guide_similar['img'])[0]) }}"
                                                alt="img" style="height: 160px; width:100%">
                                            <div class="project-item-overlay text-right">
                                                <h2>{{$guide_similar['specialization']}}</h2>
                                                <p>
                                                    <img src="{{ asset('assets/site/images/guides/' . explode(',', $guide_similar['img'])[0]) }}"
                                                        alt="user" class="avatar-xs rounded-circle">
                                                    <span class="ml-2">{{ $guide_similar['advertiser_name'] }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <h4 class="card-title">{{$guide_similar['specialization']}}</h4>
                                </div>
                            </div> 
                        </div>
                @endforeach
