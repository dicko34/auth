                        ...
                        <div class="media h-100" style="width: 100%;">
                            ...
                            <div class="media-body px-3 pt-1" style="">
                                <span style="color: #ff9800;  font-size: 13px ;font-weight: 700"><i
                                    ...
                                    والبيرة </span>
                                <h5 class="mt-2 title" style="    font-size: 1.1rem;font-family:Tajawal">محل منفصل
                                    للبيع</h5>
                    ...
                    <div class="d-none d-lg-block">
                        <div class="row mb-20px">
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                                <span><i class="fas fa-tags"></i> حاله المحل :</span> عظم
                            </div>
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                                <span><i class="fas fa-globe"></i> مساحه المحل :</span> 250 متر
                            </div>
                            <div class="col-xl-4 col-md-6" style="    line-height: 28px;">
                    ...
                    <div style="    padding: 20px;
                        ...
                        <div class="d-none d-lg-block">
                            <ul>
                                ...
                                <li style="line-height: 1.3rem !important;">محل عظم مستقل للبيع والتواصل مع المالك
                                ...
                                <li style="line-height: 1.3rem !important;"> يوجد حديقة منفصلة عن المحل </li>
