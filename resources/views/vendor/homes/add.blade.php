            ...
            <a href="{{ asset('assets/admin/images/home.jpg') }}" class="gallery-popup"
                ...
                <div class="project-item">
                    <div class="overlay-container">
                        <img src="{{ asset('assets/admin/images/home.jpg') }}" alt="img" class="gallery-thumb-img m-0"
                            style="height: 130px; width:100%">
    ...
    <table class="table table-bordered table-striped mb-0">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <select name="house_type" class="form-select form-select-sm" required="" type="text">
            ...
            <tr>
                ...
                <td>
                    <select name="house_status" class="form-select form-select-sm" required="" type="text">
            ...
            <tr>
                ...
                <td>
                    <select name="rooms" class="form-select form-select-sm" required="" type="text">
            ...
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        <input type="number" class="form-control " name="bathrooms" placeholder="عدد الحمامات"
                            aria-label="عدد الحمامات" aria-describedby="basic-addon2">
            ...
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        <input type="number" class="form-control " name="kitchens" placeholder="عدد المطابخ"
            ...
            <tr>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control " name="hell" placeholder="هل يوجد صالة؟"
                ...
                <td>
                    <div class="input-group input-group-sm">
                        <input type="number" class="form-control " name="land_area"
                            placeholder="مساحة الأرض المقام عليها البناء" aria-label="مساحة الأرض المقام عليها البناء"
                            aria-describedby="basic-addon2">
                        <span class="input-group-text" id="basic-addon2">متر مربع</span>
                    </div>
                </td>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[electronic_elevator]" type="checkbox"
                                name="property[electronic_elevator]">
                            <label class="form-check-label" for="property[electronic_elevator]"> يوجد مصعد الكتروني
                            </label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[private_car_park]" type="checkbox"
                                name="property[private_car_park]">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[central_heating]" type="checkbox"
                                name="property[central_heating]">
                            <label class="form-check-label" for="property[central_heating]"> يوجد تدفئة مركزية</label>
                        </div>
                    </div>
                </td>
            </tr>
