        ...
        <tbody>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        ...
                        <span class="input-group-text d-flex d-lg-none text-center" data-bs-toggle="tooltip"
                            data-bs-placement="left" title=""
                            style="width:50px !important;flex-wrap: nowrap; justify-content: center;" id="basic-addon2"
                            data-original-title="مثال: فولكسفايجن باسات،اوبل استرا"><i
                                class="fas fa-info-circle"></i></span>
                ...
                <td>
                    <div class="input-group input-group-sm">
                        <input required="" type="number" name="power" dir="rtl"
                            ...
                            aria-describedby="basic-addon2">
                        <span class="input-group-text  text-center" data-bs-toggle="tooltip" data-bs-placement="left"
                            title="" style="width:50px !important;flex-wrap: nowrap; justify-content: center;"
                ...
                <td>
                    <div class="input-group input-group-sm">
                        ...
                        <span class="input-group-text d-flex d-lg-none text-center" data-bs-toggle="tooltip"
                            data-bs-placement="left" title=""
                            style="width:50px !important;flex-wrap: nowrap; justify-content: center;" id="basic-addon2"
                            data-original-title="مثال: 75000 كيلومتر"><i class="fas fa-info-circle"></i></span>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="license" id="license_2" value="نمرة صفراء">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input required="" class="form-check-input" type="radio" name="fuel" id="fuel_1" value="بنزين">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input required="" class="form-check-input" type="radio" name="gear" id="gear_1" value="عادي">
                        <label class="form-check-label" for="gear_1">عادي </label>
                    </div>
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input class="form-check-input" type="radio" name="gear" id="gear_2" value="اوتوماتيك">
                        <label class="form-check-label" for="gear_2">اوتوماتيك </label>
                    </div>
                    <div class="form-check form-check-inline " style=" min-width: 53px; ">
                        <input class="form-check-input" type="radio" name="gear" id="gear_3" value="نصف اوتوماتيك">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input class="form-check-input" type="radio" name="electrical_glass" id="electrical_glass_2"
                            value="كهربائي">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input required="" class="form-check-input" type="radio" name="offer_type" id="offer_type_1"
                            value="للبيع">
                    ...
                    <div class="form-check form-check-inline " style=" min-width: 53px; ">
                        <input class="form-check-input" type="radio" name="offer_type" id="offer_type_3" value="للبدل">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check form-check-inline" style=" min-width: 53px; ">
                        <input required="" class="form-check-input" type="radio" name="payment_type" id="payment_type_1"
                            value="نقدا فقط">
                ...
                <td>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[1]" type="checkbox" name="property[1]">
                            <label class="form-check-label" for="property[1]"> جهاز إنذار</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[2]" type="checkbox" name="property[2]">
                            <label class="form-check-label" for="property[2]"> مُكيّف</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[3]" type="checkbox" name="property[3]">
                            <label class="form-check-label" for="property[3]"> مسجل CD</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[4]" type="checkbox" name="property[4]">
                            <label class="form-check-label" for="property[4]"> فتحة سقف</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[5]" type="checkbox" name="property[5]">
                            <label class="form-check-label" for="property[5]"> فرش جلد </label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[6]" type="checkbox" name="property[6]">
                            <label class="form-check-label" for="property[6]"> إغلاق مركزي</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[7]" type="checkbox" name="property[7]">
                            <label class="form-check-label" for="property[7]"> جنطات مغنيسيوم</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[8]" type="checkbox" name="property[8]">
                            <label class="form-check-label" for="property[8]"> وسادة حماية هوائية</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[9]" type="checkbox" name="property[9]">
                            <label class="form-check-label" for="property[9]"> كميرا ريفرس</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[10]" type="checkbox" name="property[10]">
                            <label class="form-check-label" for="property[10]"> حساسات</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[11]" type="checkbox" name="property[11]">
                            <label class="form-check-label" for="property[11]"> انارة لد داخلية</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[12]" type="checkbox" name="property[12]">
                            <label class="form-check-label" for="property[12]"> اضواء زينون وليدات</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[14]" type="checkbox" name="property[14]">
                            <label class="form-check-label" for="property[14]"> كاميرا 360 درجة</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[15]" type="checkbox" name="property[15]">
                            <label class="form-check-label" for="property[15]"> زجاج معتم</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[16]" type="checkbox" name="property[16]">
                            <label class="form-check-label" for="property[16]"> نظام ردار</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[17]" type="checkbox" name="property[17]">
                            <label class="form-check-label" for="property[17]"> شاشة</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[18]" type="checkbox" name="property[18]">
                            <label class="form-check-label" for="property[18]"> مثبت سرعة</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[19]" type="checkbox" name="property[19]">
                            <label class="form-check-label" for="property[19]"> هاند بريك كهرباء</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[20]" type="checkbox" name="property[20]">
                            <label class="form-check-label" for="property[20]"> فتحة سقف بانوراما</label>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" id="property[21]" type="checkbox" name="property[21]">
